...
janela = Tk()    #abrir a aba e o titulo
janela.title('Calculadora')
janela.geometry('235x310')#tamanho da aba lxc
janela.config(bg=cor1)

frame_tela = Frame(janela, width=235, height=50, bg=cor3)#adicionar espaçamentos do espaço superior
frame_tela.grid(row=0, column=0)

frame_corpo = Frame(janela, width=235, height=268)#adicionar espaçamentos do espaço inferior
...
b_16 = Button(frame_corpo, text='C', width=11, height=2, bg=cor4, font=('Ivy 13 bold'), relief=RAISED, overrelief=RIDGE)
